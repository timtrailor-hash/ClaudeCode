#!/bin/bash
# deploy_to_phone.sh — Build and install ClaudeCode to the connected iPhone.
...
APP_PATH=$(find ~/Library/Developer/Xcode/DerivedData/ClaudeCode-*/Build/Products/Debug-iphoneos/ClaudeCode.app -maxdepth 0 2>/dev/null | head -1)
if [[ -z "$APP_PATH" ]]; then
