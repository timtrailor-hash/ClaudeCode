...
private let termLog = Logger(subsystem: "com.timtrailor.claudecode", category: "nativeTerminal")

/// Native SSH terminal using SwiftTerm + Citadel.
/// Replaces the WKWebView/ttyd approach which suffered from iOS WebSocket kills.
struct NativeTerminalView: View {
    ...
    private var serverIP: String {
        String(ws.serverHost.split(separator: ":").first ?? "100.126.253.40")
    }
